...
// Your function here
func fizzBuzz(upto x: Int) -> [String] {
...
// Your function here
func value(_ x: Double, isGreaterThanAverageOf y: [Double]) -> Bool {
    var sumOfArray = Double()
    var averageOfArray = Double()
    var isGreater = Bool()
    for num in y {
        sumOfArray = num + num
        averageOfArray = sumOfArray / Double((y.count - 1))
    }
    if averageOfArray < x {
        isGreater = true
    } else {
